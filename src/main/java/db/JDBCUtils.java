...
/**
 * Created by kobis on 15 May, 2022 - according to lesson 9
 */
public class JDBCUtils {


    private static ResultSet createResultSet(PreparedStatement statement) throws CouponsSystemException {
        try {
            return statement.executeQuery();
        } catch (Exception e) {
            System.out.println(e);
            throw new CouponsSystemException(LayerMsg.JDBC_UTILS);
        }
    }
    ...
    private static void closeResources(Connection conn, PreparedStatement statement, ResultSet resultSet) throws CouponsSystemException {
        try {
            ConnectionPool.getInstance().returnConnection(conn);
            statement.close();
            resultSet.close();
    ...
    public static void executeQuery(String sql, Map<Integer, Object> params) throws CouponsSystemException {
        try {
            //Step 1 - Not relevant anyMore since we're using JDBC Drive Type 4
    ...
    public static List<?> executeQueryWithResults(String sql) throws SQLException, CouponsSystemException, InterruptedException {
    ...
    public static List<?> executeQueryWithResults(String sql, Map<Integer, Object> params) throws CouponsSystemException {
        try {
            List<?> rows = new ArrayList<>();
            //Step 1 - Not relevant anyMore since we're using JDBC Drive Type 4
    ...
    private static PreparedStatement addParams(PreparedStatement statement, Map<Integer, Object> params) throws CouponsSystemException {
        try {
